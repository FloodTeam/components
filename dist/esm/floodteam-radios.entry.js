...
const Radios = class {
    ...
    render() {
        return (h("ion-item", { lines: this.lines }, h("ion-label", { position: "stacked" }, this.label), h("ul", null, this.options.map((radio, index) => (h("li", { onClick: () => this.selectOption(index, radio) }, radio.name, index === this.selectedIndex ? (h("ion-icon", { name: "checkmark-circle" })) : (h("div", { class: "empty-circle" }))))))));
    }
    static get watchers() {
        return {
...
export { Radios as floodteam_radios };
