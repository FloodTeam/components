...
const ActivityFeed = class {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h("ion-grid", null, h("ion-row", { class: "ion-justify-content-between ion-align-items-center" }, h("ion-col", null, h("div", { class: "feed-header" }, h("slot", null))), h("ion-col", { class: "ion-align-self-end" }, h("fireenjin-filter-bar", { ref: (el) => (this.filterBarEl = el), paginationEl: this.paginationEl, disableSearch: true, filter: {
                label: "Filter By",
                controls: [
                    {
                        name: "tags",
...
export { ActivityFeed as floodteam_activity_feed };
