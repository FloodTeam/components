...
const InputAmount = class {
    ...
    render() {
        return (h("ion-item", null, h("ion-icon", { name: "logo-usd", slot: "start" }), this.label && h("ion-label", { position: "stacked" }, this.label), this.presets && this.presets.length && (h("div", { class: "presets", slot: "end" }, this.presets.map((preset) => (h("span", { onClick: () => this.selectPreset(preset) }, typeof preset === "string"
            ? preset
...
export { InputAmount as floodteam_input_amount };
