...
const Epay = class {
    constructor(hostRef) {
        ...
        this.ftEpayShowCommisions = createEvent(this, "ftEpayShowCommisions", 7);
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("ion-card", { class: "epay-wrapper" }, this.isBackShowing && (h("ion-button", { class: "back-button", onClick: () => this.goBack(), fill: "clear", shape: "round", size: "large", color: this.userPrefersDark ? "light" : "dark" }, h("ion-icon", { name: "arrow-back", slot: "icon-only" }))), h("div", { class: {
                owed: true,
                shrunk: this.isHeaderShrunk,
                hidden: this.isHeaderHidden,
            } }, h("span", null, this.formatUSD(this.owed), h("small", null, " owed")), h("floodteam-progress-bar", { percent: this.calculatePercentPaid() }), this.isSubTextShowing && h("p", null, this.subText)), h("ion-slides", { ref: (el) => (this.sliderEl = el), options: {
                autoHeight: true,
                allowTouchMove: false,
                simulateTouch: false,
                autoplay: false,
            }, class: { "hide-slides": this.isSlidesHidding } }, h("ion-slide", { id: "payments" }, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("div", { class: "past" }, h("h2", null, "Past Payments"), ((_b = (_a = this.job) === null || _a === void 0 ? void 0 : _a.payments) === null || _b === void 0 ? void 0 : _b.length) > 0 ? (this.job.payments.map((payment) => {
            var _a, _b;
            return (h("ion-item", { lines: "none" }, h("ion-label", { class: "ion-text-wrap" }, h("h4", null, ((_a = payment.user) === null || _a === void 0 ? void 0 : _a.firstName)
        ...
        })) : (h("floodteam-fallback", { icon: "sad", message: "No payments received yet..." }))))))), h("ion-slide", { id: "details" }, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("ion-list", null, h("floodteam-input", { class: "billee-input", iconLeft: "mail", label: "Billee Email", type: "email", name: "email", autocomplete: "off", value: this.email
                ? this.email
                : ((_c = this.customer) === null || _c === void 0 ? void 0 : _c.email)
                    ? this.customer.email
                    : null, required: true }), h("floodteam-input", { class: "amount-input", iconLeft: "logo-usd", label: "Amount", type: "number", name: "amount", autocomplete: "off", min: "5.00", step: "0.01", value: this.amount, required: true })))), h("ion-row", null, h("ion-col", { size: "6" }, h("ion-button", { color: "success", onClick: () => this.payWithCheck() }, "Pay with Check")), h("ion-col", { size: "6" }, h("ion-button", { color: "success", onClick: () => this.payWithCard() }, "Pay with Card"))))), h("ion-slide", { id: "card" }, h("floodteam-pay-card", { stripeKey: this.stripeKey, stripeStyle: {
                base: {
            ...
            } })), h("ion-slide", { id: "check" }, h("floodteam-pay-check", { loading: this.loading, ref: (el) => (this.payCheckEl = el), apiKey: this.dadeKey, url: this.dadeUrl, amount: this.amount })), h("ion-slide", { id: "confirmation" }, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("p", { class: "confirm-title" }, "Confirm Payment of"), h("h1", null, this.formatUSD(this.amount)), this.error && h("floodteam-error", { message: this.error }), h("ion-list", null, h("ion-item", null, h("ion-icon", { slot: "start", name: "person" }), h("div", null, h("p", null, "From"), h("h4", null, ((_d = this.customer) === null || _d === void 0 ? void 0 : _d.firstName)
            ? this.customer.firstName
            : "Customer", " ", ((_e = this.customer) === null || _e === void 0 ? void 0 : _e.lastName)
            ? this.customer.lastName
            : "Name"))), h("ion-item", null, h("ion-icon", { slot: "start", name: "mail" }), h("div", null, h("p", null, "Send receipt to"), h("h4", null, this.email ? this.email : "Customer Email"))), h("ion-item", null, h("ion-icon", { slot: "start", name: "logo-usd" }), h("div", null, h("p", null, this.paymentType === "manual"
            ? `Paying manually`
            : `Paying with ${this.capitalize(this.paymentType)}`), h("div", { innerHTML: this.getPaymentTypeCofirmation() }))), h("ion-grid", null, h("ion-row", { class: "ion-align-items-center" }, h("ion-col", { size: "12", class: "ion-align-self-end" }, h("ion-button", { onClick: () => this.approve(), color: "success" }, "Approve"))))))))), h("ion-slide", { id: "success" }, h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("floodteam-checkmark", { ref: (el) => (this.checkmarkEl = el) }), h("p", null, "You're good to go!"))))))));
    }
    get epayEl() { return getElement(this); }
    static get watchers() {
        return {
            "owed": ["onOwedChange"],
            "total": ["onTotalChange"]
