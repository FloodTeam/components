...
const SignaturePad = class {
    ...
    render() {
        return (h("ion-card", { id: "signature-pad", class: "signature-pad" }, h("canvas", { ref: (el) => (this.canvasEl = el), height: "200", width: "" }), h("ion-icon", { class: "undo", name: "arrow-undo-circle-outline", onClick: () => this.undo() }), h("div", { class: "signature-pad--footer" }, h("div", { class: "signature-pad--actions" }, h("ion-button", { fill: "outline", color: "medium", onClick: () => this.clear() }, this.clearText), h("p", null, this.label), h("ion-button", { color: "success", fill: "solid", onClick: () => this.submit() }, this.submitText)))));
    }
    static get watchers() {
        return {
            "value": ["onDataChange"],
...
export { SignaturePad as floodteam_signature_pad };
