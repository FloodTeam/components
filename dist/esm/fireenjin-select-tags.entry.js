...
import { c as createCommonjsModule, g as getDefaultExportFromCjs } from './_commonjsHelpers-5ec8f9b7.js';
...
const SelectTags = class {
  ...
  render() {
    ...
    return (h("ion-item", { ref: (el) => (this.itemEl = el), lines: "full" }, this.label && h("ion-label", { position: "stacked" }, this.label), h("select", { disabled: this.disabled, multiple: this.multiple, name: this.name, required: this.required, ref: (el) => (this.choicesEl = el) }, h("slot", null), !this.multiple && this.placeholder ? (h(OptionEl, { placeholder: true }, this.placeholder)) : null, this.options.map((option) => (h("option", { selected: this.multiple
