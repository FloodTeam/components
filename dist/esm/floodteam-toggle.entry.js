...
const Toggle = class {
    ...
    render() {
        return (h("ion-item", null, this.label && h("ion-label", null, this.label), h("ion-toggle", { color: "success", name: this.name, checked: !!this.value })));
    }
};
Toggle.style = toggleCss;

export { Toggle as floodteam_toggle };
