...
const Fallback = class {
    ...
    render() {
        return (h("div", { class: "fallback-wrapper" }, this.icon ? h("ion-icon", { name: this.icon }) : null, h("p", null, this.message)));
    }
};
...
export { Fallback as floodteam_fallback, Slide as ion_slide, Slides as ion_slides };
