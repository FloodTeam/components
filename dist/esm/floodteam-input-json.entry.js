...
const InputJson = class {
    ...
    render() {
        return (h("ion-item", { style: { overflow: "visible" } }, this.label && h("ion-label", { position: "stacked" }, this.label), h("fireenjin-json-editor", { style: { width: "100%", marginTop: "15px" }, name: this.name, value: this.value ? this.value : {} })));
    }
};
InputJson.style = inputJsonCss;

export { InputJson as floodteam_input_json };
