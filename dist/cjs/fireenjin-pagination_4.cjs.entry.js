...
const index$1 = require('./index-92dfc60e.js');
const ionicGlobal = require('./ionic-global-c9d0903e.js');
const index$2 = require('./index-427d03fb.js');
...
const Pagination = class {
  ...
  renderResults() {
    return this.display === "grid" ? (index.h("ion-grid", null, index.h("ion-row", null, this.results.map((result) => typeof this.gridEl({ result }, null, null) === "string" ? (index.h("ion-col", { innerHTML: this.gridEl({ result }, null, null) })) : (index.h("ion-col", null, this.gridEl({ result }, null, null))))))) : (index.h("ion-card", null, index.h("ion-list", null, this.results.map((result) => typeof this.listEl({ result }, null, null) === "string" ? (index.h("div", { innerHTML: this.listEl({ result }, null, null) })) : (this.listEl({ result }, null, null))))));
  }
  render() {
    return (index.h("div", { class: "pagination" }, this.disableVirtualScroll ? (index.h("div", null, this.renderResults())) : (index.h("ion-virtual-scroll", { items: this.results, approxItemHeight: this.approxItemHeight, renderItem: this.renderItem, ref: (el) => (this.virtualScrollEl = el) }, this.renderResults())), index.h("ion-infinite-scroll", { style: { display: "block" }, ref: (el) => (this.infiniteScrollEl = el) }, index.h("ion-infinite-scroll-content", { "loading-spinner": this.loadingSpinner, "loading-text": this.loadingText }))));
  }
...
exports.fireenjin_pagination = Pagination;
