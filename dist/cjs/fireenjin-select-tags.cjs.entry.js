...
var choices = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
/* harmony default export */ __webpack_exports__["default"] = (choices_Choices);
...
const Choices = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(choices);
...
const SelectTags = class {
  ...
  render() {
    ...
    return (index.h("ion-item", { ref: (el) => (this.itemEl = el), lines: "full" }, this.label && index.h("ion-label", { position: "stacked" }, this.label), index.h("select", { disabled: this.disabled, multiple: this.multiple, name: this.name, required: this.required, ref: (el) => (this.choicesEl = el) }, index.h("slot", null), !this.multiple && this.placeholder ? (index.h(OptionEl, { placeholder: true }, this.placeholder)) : null, this.options.map((option) => (index.h("option", { selected: this.multiple
...
exports.fireenjin_select_tags = SelectTags;
