...
const Checkmark = class {
    ...
    render() {
        return (index.h(index.Host, { style: {
            ...
            } }, index.h("ion-icon", { name: "checkmark-circle" }))));
    }
};
...
const InputAddress = class {
    constructor(hostRef) {
        ...
        this.floodteamAddressMode = index.createEvent(this, "floodteamAddressMode", 7);
        this.floodteamUpdateAutoHeight = index.createEvent(this, "floodteamUpdateAutoHeight", 7);
        /**
    ...
    render() {
        ...
        return [
            index.h("ion-item", { class: { "is-hidden": !this.manualEntry } }, index.h("ion-label", { position: "stacked" }, this.label), index.h("div", { class: "manual-fields" }, index.h("ion-input", { ref: (el) => (this.streetInputEl = el), type: "text", name: this.name + ".street", placeholder: "Street Address", value: value.street, required: this.required && this.manualEntry }), index.h("ion-input", { ref: (el) => (this.unitInputEl = el), type: "text", name: this.name + ".unit", placeholder: "Street Address 2", value: value.unit }), index.h("ion-input", { ref: (el) => (this.cityInputEl = el), type: "text", name: this.name + ".city", placeholder: "City", value: value.city, required: this.required && this.manualEntry }), index.h("ion-grid", null, index.h("ion-row", null, index.h("ion-col", { size: "6" }, index.h("floodteam-input-state", { ref: (el) => (this.stateSelectEl = el), name: this.name + ".state", value: value.state, placeholder: "State" })), index.h("ion-col", { size: "6" }, index.h("ion-input", { ref: (el) => (this.zipInputEl = el), class: "zip-input", type: "tel", name: this.name + ".zip", min: "0", max: "999999", value: value.zip, placeholder: "Zip Code", required: this.required && this.manualEntry }))))), index.h("ion-button", { fill: "clear", color: "primary", onClick: () => this.toggleManualEntry(), slot: "end" }, index.h("span", { class: "button-inner" }, "Search", index.h("ion-icon", { name: "search" })))),
            index.h("ion-item", { class: { "is-hidden": this.manualEntry } }, index.h("ion-label", { position: "stacked" }, this.label), index.h("ion-input", { ref: (el) => (this.autocompleteFieldEl = el), class: "autocomplete-field", type: "text", placeholder: this.placeholder, value: value.full, autocomplete: "off", required: this.required && !this.manualEntry }), index.h("ion-button", { fill: "clear", color: "primary", onClick: () => this.toggleManualEntry(), slot: "end" }, index.h("span", { class: "button-inner" }, "Manual", index.h("ion-icon", { name: "create" })))),
        ];
    }
    get addressAutocompleteEl() { return index.getElement(this); }
};
...
exports.floodteam_checkmark = Checkmark;
exports.floodteam_input_address = InputAddress;
exports.floodteam_input_state = InputState;
