...
const Form = class {
  constructor(hostRef) {
    ...
    this.fireenjinReset = index.createEvent(this, "fireenjinReset", 7);
    this.fireenjinSubmit = index.createEvent(this, "fireenjinSubmit", 7);
    this.fireenjinValidation = index.createEvent(this, "fireenjinValidation", 7);
  ...
  render() {
    return (index.h("form", { ref: (el) => (this.formEl = el), name: this.name, id: this.name, action: this.action ? this.action : `${this.apiUrl ? this.apiUrl : "http://localhost:4000"}/${this.endpoint}`, method: this.method, onReset: (event) => this.reset(event), onSubmit: (event) => this.submit(event), class: { "is-loading": this.loading } }, index.h("slot", null), !this.hideControls && (index.h("ion-grid", { class: "form-controls" }, index.h("ion-row", null, index.h("ion-col", null, this.resetButton ? (index.h("ion-button", { ref: (el) => (this.resetButtonEl = el), type: "reset", fill: this.resetButtonFill, color: this.resetButtonColor, innerHTML: this.resetButton })) : null), index.h("ion-col", null, this.submitButton ? (index.h("ion-button", { ref: (el) => (this.submitButtonEl = el), type: "submit", color: this.submitButtonColor, fill: this.submitButtonFill, innerHTML: this.submitButton })) : null))))));
  }
  get fireenjinFormEl() { return index.getElement(this); }
};
Form.style = formCss;
...
const Input = class {
    ...
    renderInput() {
        if (this.type === "card") {
            ...
            return index.h("div", { id: "card-number", ref: el => (this.cardNumberEl = el) });
        }
        else if (this.type === "expiration") {
            return index.h("div", { id: "card-expiry" });
        }
        else if (this.type === "cvc") {
            return index.h("div", { id: "card-cvc" });
        }
        else {
            const inputType = this.inputType && !this.passwordVisible
                ...
                : this.type === "phone" ||
                    ...
                    ? "tel"
                    : "text";
            return (index.h("ion-input", { type: inputType, name: this.name, spellcheck: this.spellCheck, readonly: this.readOnly, multiple: this.multiple, clearInput: this.clearInput, inputMode: this.inputMode, pattern: this.pattern
                    ? this.pattern
                    : this.type === "phone"
                        ? "[0-9]{3}-[0-9]{3}-[0-9]{4}"
                        : this.type === "ssn"
    ...
    render() {
        return (index.h("ion-item", { ref: el => (this.itemEl = el), lines: "full", class: {
                "input-password item-input": this.inputType === "password",
                "input-card": this.inputType === "card",
                "has-info-bubble": !!this.info
            } }, this.iconLeft && index.h("ion-icon", { name: this.iconLeft, slot: "start" }), this.label && (index.h("ion-label", { position: "stacked" }, index.h("span", null, this.label))), this.renderInput(), this.type === "password" && (index.h("div", { class: "input-icon" }, index.h("ion-icon", { name: this.passwordVisible ? "eye-off" : "eye", onClick: (event) => this.togglePassword(event) }))), this.iconRight && index.h("ion-icon", { name: this.iconRight, slot: "start" })));
    }
    get inputEl() { return index.getElement(this); }
    static get watchers() {
        return {
            "value": ["onValueChange"]
        };
...
exports.fireenjin_form = Form;
exports.floodteam_input = Input;
