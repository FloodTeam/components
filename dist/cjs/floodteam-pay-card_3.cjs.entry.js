...
const PayCard = class {
    constructor(hostRef) {
        ...
        this.ftSubmitCard = index.createEvent(this, "ftSubmitCard", 7);
        this.ftCardError = index.createEvent(this, "ftCardError", 7);
        this.ftCancel = index.createEvent(this, "ftCancel", 7);
    ...
    render() {
        return (index.h("div", { class: this.isLoading ? "pay-card-wrapper is-loading" : "pay-card-wrapper" }, this.error ? index.h("floodteam-error", { message: this.error }) : null, index.h("div", { id: "card-element" }), index.h("ion-grid", null, index.h("ion-row", null, index.h("ion-col", { size: "6" }, index.h("ion-button", { onClick: event => this.cancel(event), fill: "clear" }, "Cancel")), index.h("ion-col", { size: "6" }, index.h("ion-button", { color: "success", onClick: event => this.save(event) }, "Save"))))));
    }
    get payCardEl() { return index.getElement(this); }
    static get watchers() {
        return {
...
const PayCheck = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.ftSubmitCheck = index.createEvent(this, "ftSubmitCheck", 7);
        this.ftCheckConfirmation = index.createEvent(this, "ftCheckConfirmation", 7);
        this.ftCheckScan = index.createEvent(this, "ftCheckScan", 7);
        this.ftCheckError = index.createEvent(this, "ftCheckError", 7);
        this.ftCancel = index.createEvent(this, "ftCancel", 7);
    ...
    render() {
        return (index.h("form", { id: "form-check", onDrop: event => this.onDrop(event), onDragOver: event => this.onDrag(event), onDragEnter: event => this.onDragEnter(event), onDragLeave: event => this.onDragLeave(event), onSubmit: event => this.onSubmit(event), class: {
                "is-loading": this.loading
            } }, this.errors.map(error => (index.h("floodteam-error", { message: error.error_message }))), index.h("input", { ref: el => (this.fileInputEl = el), type: "file", accept: "image/*", onChange: event => this.selectFile(event), capture: "camera" }), index.h("floodteam-flip-card", { class: {
                "check-drag-hover": this.isHovered
            }, frontImage: this.checkFront, backImage: this.checkBack, onClick: () => this.openCamera(), flipped: !this.isScanningFront }, index.h("div", { slot: "front" }, index.h("span", { class: "badge-top-right" }, "Front")), index.h("div", { slot: "back" }, index.h("span", { class: "badge-top-right" }, "Back"))), index.h("ion-grid", null, index.h("ion-row", null, index.h("ion-col", { size: "6" }, index.h("ion-button", { fill: "clear", onClick: event => this.cancel(event) }, "Cancel")), index.h("ion-col", { size: "6" }, index.h("ion-button", { color: "success", onClick: event => this.save(event) }, "Save"))))));
    }
    get payCheckEl() { return index.getElement(this); }
    static get watchers() {
        return {
            "url": ["onUrlChange"]
        };
...
const ProgressBar = class {
    ...
    render() {
        return index.h("div", { class: "progress-bar-wrapper" });
    }
    get progressBarEl() { return index.getElement(this); }
    static get watchers() {
        return {
...
exports.floodteam_pay_card = PayCard;
exports.floodteam_pay_check = PayCheck;
exports.floodteam_progress_bar = ProgressBar;
