...
const Select = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ion-item", null, this.icon && index.h("ion-icon", { slot: "start", name: this.icon }), this.label && index.h("ion-label", { position: this.labelPosition }, this.label), index.h("ion-select", { disabled: this.disabled, selectedText: this.selectedText, interface: this.interface, compareWith: this.compareWith, name: this.name, value: this.value, okText: this.okText, multiple: this.multiple, cancelText: this.cancelText, placeholder: this.placeholder, interfaceOptions: this.interfaceOptions ? this.interfaceOptions : {
        header: this.header,
        subHeader: this.subHeader,
        message: this.message,
      } }, (this.options ? this.options : []).map((option) => this.optionEl ? (this.optionEl(option)) : (index.h("ion-select-option", { value: option.value, disabled: option.disabled }, option.label))), (this.results ? this.results : []).map((result) => this.optionEl ? (this.optionEl(result)) : (index.h("ion-select-option", { value: result.id }, result.name)))))));
  }
  get selectEl() { return index.getElement(this); }
};
...
exports.fireenjin_select = Select;
