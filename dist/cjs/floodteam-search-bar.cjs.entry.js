...
const SearchBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "search-bar-wrapper" }, index.h("ion-searchbar", { disabled: this.disabled }), this.showFilter && ((_b = (_a = this.filter) === null || _a === void 0 ? void 0 : _a.controls) === null || _b === void 0 ? void 0 : _b.length) && index.h("div", { class: "filter-bar" }, ((_d = (_c = this.filter) === null || _c === void 0 ? void 0 : _c.controls) === null || _d === void 0 ? void 0 : _d.length) && ((_e = this.filter) === null || _e === void 0 ? void 0 : _e.controls.map(control => (index.h("ion-chip", { outline: !Object.keys(this.currentFilters).includes(control === null || control === void 0 ? void 0 : control.name), onClick: (event) => this.fireenjinTrigger.emit({
                event,
                trigger: "filter",
            ...
            }) }, (control === null || control === void 0 ? void 0 : control.icon) && index.h("ion-icon", { name: control.icon }), (control === null || control === void 0 ? void 0 : control.label) && index.h("ion-label", null, this.getControlLabel(control)), Object.keys(this.currentFilters).includes(control === null || control === void 0 ? void 0 : control.name) && index.h("ion-icon", { name: "close-circle", onClick: (event) => this.clearFilter(event, control) }))))))), ((_g = (_f = this.filter) === null || _f === void 0 ? void 0 : _f.controls) === null || _g === void 0 ? void 0 : _g.length) && index.h("ion-button", { onClick: () => this.showFilter = !this.showFilter, class: "filter-button", size: "small", fill: "clear", shape: "round", style: { color: "var(--ion-text-color)" } }, index.h("ion-icon", { name: "funnel", slot: "icon-only" }), ((_h = Object.keys(this.currentFilters)) === null || _h === void 0 ? void 0 : _h.length) && index.h("ion-badge", { slot: "end" }, this.currentFilters ? Object.keys(this.currentFilters).length : 0))));
    }
    static get watchers() {
        return {
...
exports.floodteam_search_bar = SearchBar;
