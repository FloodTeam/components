...
export class Form implements ComponentInterface {
   ...
   */
  @Event() floodteamReset: EventEmitter<{
    event;
    id: string;
    endpoint: string;
    data: any;
   ...
   */
  @Event() floodteamSubmit: EventEmitter<{
    event;
    id: string;
    endpoint: string;
    data: any;
   ...
   */
  @Event() floodteamValidation: EventEmitter<{
    event;
    isValid: boolean;
    name: string;
  }>;
  ...
  async onSuccess(event) {
    if (event.detail.target === this.floodteamFormEl) {
  ...
  /**
   * Emit floodteamSubmit event with form data
  ...
  /**
   * Emit floodteamReset event with form data
  ...
  async checkFormValidity(reportValidity = true) {
    ...
    const inputEls = [].slice.call(
      this.formEl.querySelectorAll("floodteam-input")
    );
