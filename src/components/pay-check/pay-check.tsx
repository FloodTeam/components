    ...
    return (
      ...
      >
        ...
        <floodteam-flip-card
          ...
          frontImage={this.checkFront}
          backImage={this.checkBack}
          onClick={() => this.openCamera()}
          flipped={!this.isScanningFront}
        >
          <div slot="front">
            <span class="badge-top-right">Front</span>
          </div>
          <div slot="back">
            <span class="badge-top-right">Back</span>
          </div>
        </floodteam-flip-card>
        <ion-grid>
          <ion-row>
